    ...
    image: (
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '40px', textAlign: 'center' }}>Choose your difficulty level:</p>
          <p style={{ fontSize: '32px', marginBottom: '10px', textAlign: 'center' }}>🟢 Easy: For casual fun</p>
          <p style={{ fontSize: '32px', marginBottom: '10px', textAlign: 'center' }}>🟡 Medium: For a challenge</p>
          <p style={{ fontSize: '32px', marginBottom: '10px', textAlign: 'center' }}>🔴 Hard: For experts</p>
        </div>
      </div>
    ),
    intents: [
